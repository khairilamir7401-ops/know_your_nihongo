...
import 'word_food_model.dart';
export 'word_food_model.dart';

class WordFoodWidget extends StatefulWidget {
  const WordFoodWidget({Key? key}) : super(key: key);

  @override
  _WordFoodWidgetState createState() => _WordFoodWidgetState();
}

class _WordFoodWidgetState extends State<WordFoodWidget> {
  late WordFoodModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WordFoodModel());
  }
