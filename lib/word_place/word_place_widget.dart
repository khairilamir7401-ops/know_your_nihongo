...
import 'word_place_model.dart';
export 'word_place_model.dart';

class WordPlaceWidget extends StatefulWidget {
  const WordPlaceWidget({Key? key}) : super(key: key);

  @override
  _WordPlaceWidgetState createState() => _WordPlaceWidgetState();
}

class _WordPlaceWidgetState extends State<WordPlaceWidget> {
  late WordPlaceModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WordPlaceModel());
  }
