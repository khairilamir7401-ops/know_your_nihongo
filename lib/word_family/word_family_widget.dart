...
import 'word_family_model.dart';
export 'word_family_model.dart';

class WordFamilyWidget extends StatefulWidget {
  const WordFamilyWidget({Key? key}) : super(key: key);

  @override
  _WordFamilyWidgetState createState() => _WordFamilyWidgetState();
}

class _WordFamilyWidgetState extends State<WordFamilyWidget> {
  late WordFamilyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WordFamilyModel());
  }
