...
import 'word_animal_model.dart';
export 'word_animal_model.dart';

class WordAnimalWidget extends StatefulWidget {
  const WordAnimalWidget({Key? key}) : super(key: key);

  @override
  _WordAnimalWidgetState createState() => _WordAnimalWidgetState();
}

class _WordAnimalWidgetState extends State<WordAnimalWidget> {
  late WordAnimalModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => WordAnimalModel());
  }
